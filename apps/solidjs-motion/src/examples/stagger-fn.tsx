// solidjs-motion has no scoped `createAnimate`; use the re-exported `animate`
// with a selector (document-scoped — fine for a single instance on the page).
// `stagger` isn't re-exported either; it lives in motion-dom.
