  ...
  return (
    <>
      <section class="relative mx-auto max-w-[860px] overflow-hidden px-5 pt-16 pb-10 sm:px-7 sm:pt-24 text-center">
        ...
        >
          A complete reference for every motion-solidjs component, primitive and function — each
        ...
        <div class="mt-6 font-mono text-[0.75rem] uppercase tracking-[0.18em] text-fg-dim">
          motion-solidjs · {docs.length} APIs · {registry.length} examples
        </div>
      </section>
...
const summaries: Record<string, string> = {
  ...
  components: 'motion.*, AnimatePresence, LayoutGroup, Reorder…',
  primitives: 'useMotion, createAnimate, createSpring, createScroll…',
